...
export default function BevelPage () {
  ...
  const renderParams = { canvasSize, imageScale, imageOffsetX, imageOffsetY, bgColor, fgColor, preprocessing, depth, lightAngle, effectThreshold }
  ...
  return (
    <>
      ...
      <ControlPanel>
        ...
        <ExportButton onExport={useCallback(() => { if (p5Ref.current) p5Ref.current.saveCanvas('bevel', 'png') }, [p5Ref])} videoExport={videoExport} animationEnabled={anim.enabled} />
      </ControlPanel>
    </>
  )
}
